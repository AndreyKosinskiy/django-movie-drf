    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='Сборы в миру')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('diretors', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='режиссер')),
